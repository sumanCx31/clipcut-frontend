...
export default function AuthLayout(): React.ReactElement {
  return (
    <div className="relative min-h-screen w-full bg-[#090a0f] text-slate-200 flex items-center justify-center p-4 sm:p-6 font-sans selection:bg-indigo-500/30 selection:text-indigo-200">
      <div 
        className="absolute inset-0 bg-[linear-gradient(to_right,#1e293b15_1px,transparent_1px),linear-gradient(to_bottom,#1e293b15_1px,transparent_1px)] bg-[size:4rem_4rem] [mask-image:radial-gradient(ellipse_60%_50%_at_50%_50%,#000_80%,transparent_100%)] pointer-events-none" 
      />
